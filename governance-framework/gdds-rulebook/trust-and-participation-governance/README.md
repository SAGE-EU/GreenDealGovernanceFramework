...
* **Individual Participants** — natural persons (such as freelancers, private consultants, and independent researchers) who participate in their own capacity, not as representatives of a legal entity.&#x20;

{% hint style="warning" %}
_Note: The specific limitations applicable to Individual Participants are set out in the onboarding and access-rights provisions below and are being finalised with WP3. As it is foreseen now, the specific restrictions on Individual Participants depend on the role and assurance mapping being finalised with WP3, which is Phase 2 work (from September 2026)._
{% endhint %}
...
* Data Providers — A natural or legal person who discloses or grants access to data for sharing or re-use within the context of data space.  
* [Data User ](#user-content-fn-1)[^1]— A natural or legal person who has lawful access to certain personal or non-personal data and has the right, including under Regulation (EU) 2016/679 in the case of personal data, to use that data for commercial or non-commercial purposes. 
* Data Rights Holders — A party that has legal rights and/or obligations to use, grant access to or share certain personal or non-personal data resources. Data rights holders may transfer such rights to others. 
* [(Data Space/ Data)](#user-content-fn-2)[^2]Intermediaries — A party that provides the data space’s shared enabling and trust functions (connectors, catalogue and brokerage, registry, trust services) without being a party to the underlying data transaction. Holds the certified infrastructure roles (Participant Registry, Authorisation Registry, Identity Provider) where applicable.
...
* Certain roles are certified roles. Intermediaries and Service Providers must pass conformity assessment before admission and maintain valid certification thereafter. The certification mechanism is defined under Conformity Framework & Governance Enforcement (see [here](../conformity-framework-and-governance-enforcement/)).&#x20;
...
[^1]: Note: some may refer to it as Data recipient or consumer, but the GDDS has decided to follow the DGA term 'Data User'. Since the DGA constitutes the governing legal framework for EU data spaces, the consistent use of the term data user is advisable, avoiding GDPR‑specific notions such as data recipient or alternative labels such as data consumer. Where appropriate, one may refer to data user, noting that data consumer can also be used.

[^2]: in our glossary, currently both of these appear with similar meaning

[^3]: To consider 'Intermediation Service Provider'
