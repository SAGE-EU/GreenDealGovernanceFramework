...
The SAGE project’s Working Group 7 \[ref] developed a business model for the GDDS based on the DSSC business model \[ref], conceiving the GDDS as a multi-actor ecosystem, with the Data Space serving as a key coordination layer connecting multiple participant groups and use cases. As described in D7.1, a key feature of this model is the one-to-many relationship between the GDDS and multiple use cases built on top of that Data Space, enabling a common shared infrastructure and governance framework to support diverse domain-specific applications, such as forestry, construction, textiles, and environmental monitoring, each deriving value from the shared capabilities. Read more [here ](use-cases.md)about the GDDS initial Use Cases.&#x20;
...
A particularly important aspect of the GDDS business model is the separation between governance and operations. The governance authority (represented by the general assembly in the case of the GDDS) is responsible for defining the rules, policies, and trust framework for the data space, ensuring compliance, transparency, and alignment with regulatory requirements. In contrast to the governance layer, the operational layer can be executed by one or more service providers, including private sector organisations, potentially offering competitive services, which deliver the technical infrastructure, federation services, and value-added capabilities required to operate the Data Space.&#x20;
