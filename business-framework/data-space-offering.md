...
3. **Participant Interoperability** is provided through support for participants' Data Connectors, which allow data to be exchanged in a decentralised, sovereignty-preserving manner rather than through a central repository. In the GDDS, any type of Data Connector can be used, as long as it adheres to the contract and protocols required by SAGE. &#x20;
...
| PSNC         | Data Harmonisation Service                | Service for harmonising heterogeneous input datasets into common data models. Detailed questionnaire submission pending.                                                                               |
