...
{% hint style="warning" %}
_This section will be further modified, and additional information will be added to it after the development in WP4, WP3, and WP6. Therefore, this section is an initial draft._&#x20;
{% endhint %}
...
Access conditions apply not only at the point of data exchange but also at discovery: a participant's view of available data products [may be filtered ](#user-content-fn-2)[^2]according to its verified attributes, so that participants see and can request only what they are eligible to access.&#x20;
...
[^2]: this would be required if also the metadata of the restricted data are restricted - even for MVP2 (comment by EODC)
