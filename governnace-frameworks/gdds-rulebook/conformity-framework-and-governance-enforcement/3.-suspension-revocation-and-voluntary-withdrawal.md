...
{% hint style="warning" %}
_Note (open, action assigned Session 10): The legal and technical feasibility of asset handling during suspension or exclusion is to be analysed (action: Salvatore Sapienza). In particular, under the Data Act a copy of the exchanged data may need to be left with the data consumer upon termination of a commercial relationship; this specific obligation is to be verified (action: Salvatore Sapienza) and reflected here and in the Legal Framework._&#x20;
{% endhint %}
