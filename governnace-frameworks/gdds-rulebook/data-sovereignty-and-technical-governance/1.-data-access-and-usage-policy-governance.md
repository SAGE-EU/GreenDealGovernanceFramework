...
{% hint style="warning" %}
_Open stakeholder questions to resolve here: the data-sharing agreement template and mandatory minimum clauses — licence, liability, observability, dispute resolution (raised by JuanJose Suarez Burgos); how sensitive and commercial datasets are classified and governed (Suarez Burgos); whether GDDS access control should coordinate with the EU Digital Product Passport access-control system to avoid duplication (James Kenny); and two-layer access control with role-change and leaver handling — institution authenticated by a governance body, individual by their organisation (Geert Machtelinckx). Owner: WP4, with WP6 for UC consent requirements and UNIBO for legal alignment._&#x20;
{% endhint %}
