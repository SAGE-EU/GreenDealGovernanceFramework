...
{% hint style="warning" %}
_Open governance questions to resolve (raised by JuanJose Suarez Burgos): who operates and maintains the catalogue, during the project and in the longer term; and what rules apply to metadata standards, including quality assurance and validation against GDDS-defined schemas. The operator/maintenance question is a governance matter for Registry and discovery governance (Data Sovereignty & Technical Governance, subsection 4); the metadata-standard rules link to Data, Services and Offerings Descriptions. Owner: WP3 / CYFRONET, with WP4 for the governance rules._&#x20;
{% endhint %}
